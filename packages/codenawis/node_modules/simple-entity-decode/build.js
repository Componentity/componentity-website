...
var ENTITY_REGEX = /&(?:#(?:([0-9]+)|x([a-fA-F0-9]+))|(amp|apos|quot|lt|gt));/g;
var NAMED_ENTITIES = {
  amp: '&',
  apos: "'",
  quot: '"',
...
function decodeEntities(text) {
  return text.replace(ENTITY_REGEX, function (_, decimal, hex, named) {
    if (named) {
      return NAMED_ENTITIES[named];
    }

    var codePoint = decimal ? parseInt(decimal, 10) : parseInt(hex, 16);
...
exports.codePointToSymbol = codePointToSymbol;
